...
<h3 class="mt-5 text-center mb-5">Ajoute une nouvelle Salle de Réunion</h3>
	<form method="post" action="save-salle" enctype="multipart/form-data" style="margin-top: 15px;">
	  <!-- 2 column grid layout with text inputs for the first and last names -->
	  <div class="row mb-4">
	    <div class="col">
	      <div class="form-outline">
	        <input type="text" id="form6Example1" class="form-control" name="salleId"/>
	        <label class="form-label" for="form6Example1">Salle Id</label>
	      </div>
	    </div>
	    <div class="col">
	      <div class="form-outline">
	        <input type="text" id="form6Example2" class="form-control" name="salleNom"/>
	  ...
	  <div class="form-outline mb-4">
	    <input type="text" id="form6Example3" class="form-control" name="localisation"/>
	    <label class="form-label" for="form6Example3">Localisation</label>
	  </div>
	
	  <!-- Number input -->
	  <div class="form-outline mb-4">
	    <input type="number" id="form6Example6" class="form-control" name="capacite"/>
	    <label class="form-label" for="form6Example6">Capacite</label>
	  </div>
	  
	  <!-- Number input -->
	  <div class="form-outline mb-4">
	    <input type="number" id="form6Example4" class="form-control" name="tarif"/>
