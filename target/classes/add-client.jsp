...
<title>Créer un nouveau compte pour un client</title>
</head>
<body>
<header>
  <!-- Sidebar -->
...
<form method = "post" action = "save-client" style="margin-top: 15px;">
  ...
  <div class="form-outline mb-4">
    <input type="text" id="form6Example3" class="form-control" name="nom_entreprise" />
  ...
  <div class="form-outline mb-4">
	...
	<!-- Text input -->
  <div class="form-outline mb-4">
    <input type="text" id="form6Example5" class="form-control" name="phone"/>
